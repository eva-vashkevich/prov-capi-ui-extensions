...
export default {
  ...
  async fetch() {
    ...
    try {
      ...
      const region = this.infrastructureCluster?.spec?.region;
  ...
  computed: {
    ...
    isIamInstanceProfileNameRequired() { // TODO
      return this.infrastructureCluster?.cloudProvider === 'aws';
    },
    ...
    infrastructureClusterRegion() {
      return this.infrastructureCluster?.spec?.region || null;
    }
  },
  ...
  watch: {
    ...
    infrastructureClusterRegion(newRegion, oldRegion) {
